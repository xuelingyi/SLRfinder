...
## NB! VCF files in the ./a15m75/ folder are named as mydata_LGx_a15m75.recode.vcf. Modify this (line 87) if your files are named differently (e.g., without recode). If your vcf files are compressed (.vcf.gz), you need to use the command vcftools --gzvcf (not --vcf). 
